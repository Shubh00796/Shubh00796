...
| ------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **IntelStream: High-Performance Real-Time Market Intelligence Platform** | A scalable, cleanly architected backend platform for real-time market data ingestion, analytics, command-query separation, and serving insights via REST and WebSocket APIs using DDD and Hexagonal architecture. | Java 17 · Spring Boot 3.x · Clean Architecture (DDD + Hexagonal) · CQRS · REST · WebSocket · MySQL · JPA · MapStruct · Kafka (planned) · Redis (optional) · Maven | [![GitHub](https://img.shields.io/badge/Repo-IntelStream-181717?logo=github)](https://github.com/Shubh00796/IntelStream-High-Performance-Real-Time-Market-Intelligence-Platform) |
...
🐦 [Twitter / X](https://x.com/s_h_u_b_h_0_0_7)
